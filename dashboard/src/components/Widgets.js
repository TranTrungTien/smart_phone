    ...
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        <Card.Img
          src={Profile1}
          alt="Neil Portrait"
          className=" large-avatar rounded-circle mx-auto mt-n7 mb-4"
        />
...
export const TeamMembersWidget = () => {
  const TeamMember = (props) => {
    const { name, statusKey, image, icon, btnText, index } = props;
    const status = {
      online: { color: "success", label: "Online" },
      inMeeting: { color: "danger", label: "Offline" },
    ...
    return (
      <ListGroup.Item className="px-0">
        <Row style={{ maxWidth: "100%" }} className="align-items-center">
  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header className="border-bottom border-light d-flex justify-content-between">
        <h5 className="mb-0">Thành viên tích cực</h5>
        <Button variant="secondary" size="sm">
          Xem tất cả
        </Button>
      </Card.Header>
      <Card.Body>
        <ListGroup className="list-group-flush list my--3">
          {teamMembers.map((tm, index) => (
            <TeamMember key={`team-member-${tm.id}`} {...tm} index={index} />
          ))}
        </ListGroup>
      </Card.Body>
    </Card>
  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header className="border-bottom border-light">
        <h5 className="mb-0">Đơn hàng đang xử lý</h5>
      </Card.Header>
      <Card.Body>
        <Progress
          title="Iphone 14 - Nguyễn thị Phương"
          color="purple"
          icon={faBootstrap}
          percentage={34}
        />
        <Progress
          title="Iphone X - Nguyễn thị Phương"
          color="danger"
          icon={faAngular}
          percentage={60}
        />
        <Progress
          title="Iphone 12 - Nguyễn thị Phương Anh"
          color="tertiary"
          icon={faVuejs}
          percentage={45}
        />
        <Progress
          title="Iphone 14 - Nguyễn thị Anh"
          color="info"
          icon={faReact}
          percentage={35}
        />
        <Progress
          last
          title="Iphone 11 - Nguyễn thị Thi"
          color="purple"
          icon={faBootstrap}
          percentage={34}
        />
